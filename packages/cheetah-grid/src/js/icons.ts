...
const builtins = {
  ...
  get edit(): IconDefine {
    ...
    return {d: 'M6 34.5V42h7.5l22.13-22.13-7.5-7.5L6 34.5zm35.41-20.41c.78-.78.78-2.05 0-2.83l-4.67-4.67c-.78-.78-2.05-.78-2.83 0l-3.66 3.66 7.5 7.5 3.66-3.66z',
    width: 48,
    height: 48
  };
  },
  get add(): IconDefine {
    ...
    return {d: 'M38 26H26v12h-4V26H10v-4h12V10h4v12h12v4z',
    width: 48,
    height: 48
  };
  },
  get star(): IconDefine {
    ...
    return {d: 'M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z',
    width: 24,
    height: 24
  };
  },
